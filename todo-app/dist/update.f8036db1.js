...
})({"4gydz":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "0b27635ff8036db1";
"use strict";
...
},{}],"hUKvI":[function(require,module,exports) {
...
let todo;
_axiosDefault.default.get(apiUrl + `/${item_id}`).then((response)=>{
    todo = response.data;
...
submit.addEventListener("click", (e)=>{
    ...
    _axiosDefault.default.put(apiUrl + `/${item_id}`, new_item).then(alert("Todo updated!"));
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["4gydz","hUKvI"], "hUKvI", "parcelRequire66d6")

//# sourceMappingURL=update.f8036db1.js.map
